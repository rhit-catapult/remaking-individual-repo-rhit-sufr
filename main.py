    ...
    # pygame.display.init()
    # screen = pygame.display.set_mode((WIDTH, HEIGHT), pygame.DOUBLEBUF|pygame.FULLSCREEN, vsync=True)
    ...
    #             screen = pygame.display.set_mode((event.w, event.h), pygame.DOUBLEBUF|pygame.FULLSCREEN, vsync=True)
    ...
    #         player_pos.x += 300 * dt
    #
    #     player_pos.x += random.randint(0, 6) - 3
    #     player_pos.y += random.randint(0, 6) - 3
    #
    #     if player_pos.x < 0:
    #         player_pos.x = 0
